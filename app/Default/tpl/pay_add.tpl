...
<div class="pay_add">
		...
		<ul>
			...
			<li class="ammount"><span>日期:</span><input type="text" name="pay_date" style="width:80px;" value="{$smarty.now|date_format:"Y-m-d"}"/><span id="note_date" style="color:red;"></span></li>
